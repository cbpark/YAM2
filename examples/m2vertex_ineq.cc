...
int main() {
    ...
    // const auto m2sol = yam2::m2VertexIneqAugLagBFGS(input, 1.0e-10, 2000);
    // const auto m2sol = yam2::m2VertexIneqSQP(input, 1.0e-10, 2000);
    const auto m2sol = yam2::m2VertexIneq(input, 1.0e-10, 2000);
    ...
    if (!m2sol) {
        ...
        std::cout << "M2VertexIneq = " << m2sol.value().m2() << '\n'
                  << "where \n"
                  << "  k1: " << m2sol.value().k1() << '\n'
                  << "  k2: " << m2sol.value().k2() << '\n'
